...
export default function Ecommarbanner() {
        ...
        <div className="container pt-5 pb-5">
          <div className="text-center">
            <h1 className="b2b-sub-heading-bold m-0">
              <span className="devops_color"> E-Commerce Marketing</span> Services to Drive <br />
              <span className="devops_color">Sales</span> and  <span className="devops_color">Brand Growth</span>

            </h1>
          </div>
          <div className="text-center pt-3">
            <p className="text-white">
              Our e-commerce marketing services are designed to drive traffic, increase conversions, and elevate your <br /> brand’s presence online. Whether you’re a new business or an established player, our tailored strategies and <br /> data-driven insights will help you achieve your goals and maximize ROI.
            </p>
          </div>
