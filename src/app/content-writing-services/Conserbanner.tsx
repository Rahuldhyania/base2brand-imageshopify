...
export default function Conserbanner() {
        ...
        <div className="container pt-5 pb-5">
          <div className="text-center">
            <h1 className="b2b-sub-heading-bold m-0">
              <span className="devops_color">Content Writing</span> Service To
              Convert <br />
              Words <span className="devops_color"> Into Leads</span>
            </h1>
          </div>
          <div className="text-center pt-3">
            <p className="text-white">
              At our content writing company, we specialize in creating
              impactful and engaging content that drives <br /> results. From
              SEO content writing services to website content creation, our
              content writing agency ensures <br /> your brand stands out in the
              digital landscape.
            </p>
          </div>
