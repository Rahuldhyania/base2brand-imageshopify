...
const Intechoose = ({
  ...
  return (
    <div className="feature5_inte_com pt-5">
      <h2 className="inte-sub-heading2 inte_choose_h2 text-black ps-3 pe-3">
        Why Choose{" "}
        <span className="b2b_inte_com inte_com_blue">
          Base<span className="b2b_2">2</span>Brand
        </span>{" "}
        for <span className="inte_com_blue">{choosetitle}</span> {demotitle}{" "}
        Integration?
      </h2>
      <div className="title_dis_choose d-flex justify-content-center">
        <p className="b2b-title-text text-black inte_dis_choose_p">
          {choose_t_para}
        </p>
      </div>
      <div className="pb-4 pt-4">
        <div className="container ">
          <div className="row">
            <div className="col-lg-4 col-md-6 mb-2 choose_outer">
              ...
              <div className="service_box_outer call_cen_servics">
                <div className="  works-servics-radius">
                  <div className="serviceIcon">
                    <div className="inte_img_choose d-flex ">
                      {/* <Image
                      src="https://cdn.shopify.com/s/files/1/0835/6334/8002/files/02_zdivpn.webp?v=1761903202"
                      alt="01"
                      width={1000}
                      height={500}
                      style={{
              ...
              <div className="service_box_outer call_cen_servics">
                <div className="works-servics-radius">
                  <div className="serviceIcon">
                    ...
                    <h3 className="inte_choose_h3 text-black text-center inte_heading1">
                      {choose_t6}
                    </h3>
                    <div className="d-flex justify-content-between text-center align-items-end mt-1 mt-sm-1">
                      <p className="sub_text_choose text-black inte_work_heading">
