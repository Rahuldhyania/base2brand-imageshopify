...
const Inteprocess = ({
  ...
  return (
    <div className="processcon pt-5 pb-5">
            ...
            <div className="service_box_outer_pro call_cen_servics">
              <div className="works-servics-radius2">
                <div className="serviceIcon_1">
                  ...
                  <div className="d-flex justify-content-center align-items-end mt-1 mt-sm-1">
            ...
            <div className="service_box_outer_pro call_cen_servics">
              <div className="  works-servics-radius2">
                <div className="serviceIcon_2">
                  ...
                  <div className="justify-content-center inte_hover serviceIcon_2_img d-flex ">
                    <Image
                      src={process_img4}
                      alt="01"
                      width={1000}
